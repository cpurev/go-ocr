...
var parseCommandTests = []parseCommandCase{
	...
	{text: "edit 7 merchant ICA", verb: "edit", number: 7,
		update: model.ReceiptUpdate{Merchant: ptr("ICA")}},
	// A field word inside a merchant's name is part of the name.
	{text: "edit 7 merchant: Apple Store Täby", verb: "edit", number: 7,
		update: model.ReceiptUpdate{Merchant: ptr("Apple Store Täby")}},
	{text: "edit 7 merchant: Pizza Total", verb: "edit", number: 7,
		update: model.ReceiptUpdate{Merchant: ptr("Pizza Total")}},
	{text: "edit 7 merchant: The Body Shop, total: 99", verb: "edit", number: 7,
		update: model.ReceiptUpdate{Merchant: ptr("The Body Shop"), Total: ptr(99.0)}},
	{text: "edit 7 merchant ICA total 150", verb: "edit", number: 7,
		update: model.ReceiptUpdate{Merchant: ptr("ICA"), Total: ptr(150.0)}},
...
func TestParseAdd(t *testing.T) {
	tests := []struct {
		...
		{args: "228 sek Willy’s", total: 228, merchant: "Willy’s", matched: true},
		{args: "38 SEK am store", total: 38, merchant: "am store", matched: true},
		{args: "150sek ICA", total: 150, merchant: "ICA", matched: true},
		{args: "150 kr ICA", total: 150, merchant: "ICA", matched: true},
		{args: "150 kr. ICA", total: 150, merchant: "ICA", matched: true},
		{args: "150 kronor ICA", total: 150, merchant: "ICA", matched: true},
		{args: "150:- ICA", total: 150, merchant: "ICA", matched: true},
		{args: "SEK 150 ICA", total: 150, merchant: "ICA", matched: true},
		{args: "kr 150 ICA", total: 150, merchant: "ICA", matched: true},
		{args: "150 Krögers", total: 150, merchant: "Krögers", matched: true},
		{args: "150 Sekunda", total: 150, merchant: "Sekunda", matched: true},
		{args: "150 kr", matched: true, wantErr: "name the shop, e.g. add 150 ICA"},
		{args: "2 liters of milk to the list"},
		{args: "3 more bananas"},
		{args: "6 eggs to the list"},
		{args: "150 Liters Bar"},
